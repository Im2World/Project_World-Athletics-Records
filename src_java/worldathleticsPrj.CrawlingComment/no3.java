...
public class no3 {
	   ...
	   public static void main(String[] args) throws IOException {
	      // 파일 저장경로
		   File fileSave = new File("C:\\Users\\IM\\Desktop\\javaBasicPrj\\worldathleticsPrj\\crawlingData3.csv");
	      ...
	      // 사이트 진입
	         ...
	         // Men Outdoor 클릭
	         try {
	               driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/ul/li[3]/a")).click();
	               Thread.sleep(2000);
	            } catch (InterruptedException e) {
	               e.printStackTrace();
	            }
	         ...
	         int progressionTrSize = driver.findElements(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[3]/table/tbody/tr")).size();
	        ...
	        //Men Outdoor 재클릭
	         ...
	         // Progression 화살표 클릭
	         driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[3]/table/tbody/tr[" + k + "]/td[2]/a/i")).click();
