...
public class no5 {
	  // 크롬드라이버 설정
	   ...
	   public static void main(String[] args) throws IOException {
	      // 파일 저장경로
		   File fileSave = new File("C:\\Users\\IM\\Desktop\\javaBasicPrj\\worldathleticsPrj\\crawlingData5.csv");
	      ...
	      // 사이트 진입
	         ...
	         // Tab5 클릭
	         try {
	               driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/ul/li[5]/a")).click();
	               Thread.sleep(2000);
	            } catch (InterruptedException e) {
	               e.printStackTrace();
	            }
	         // progression tr의 행개수_ tr은 열
	         int progressionTrSize = driver.findElements(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[5]/table/tbody/tr")).size();
	         System.out.println(progressionTrSize);
	         
	         // Mixed Outdoor tab 클릭 
	         try {
	            driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/ul/li[5]/a")).click();
	            Thread.sleep(3000);
	         } catch (InterruptedException e) {
	         ...
	         //Progression 화살표 클릭
	         driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[5]/table/tbody/tr/td[2]/a/i")).click();
