...
public class no1 {
	   ...
	   public static void main(String[] args) throws IOException {
	      // 파일 저장경로
		  File fileSave = new File("C:\\Users\\IM\\Desktop\\javaBasicPrj\\worldathleticsPrj\\crawlingData1.csv");
	      ...
	      // 사이트 진입
	         ...
	         int progressionTrSize = driver.findElements(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[1]/table/tbody/tr")).size();
	         System.out.println(progressionTrSize);   //53
	         
	         for(int k = 1; k < progressionTrSize; k++) {
	         
	         // Progression 클릭
	         // 마지막 항목은 /html/body/div[3]/div/div[3]/div/div[1]/div[1]/table/tbody/tr[53]/td[2]/a/i
	         driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div/div[1]/div[1]/table/tbody/tr[" + k + "]/td[2]/a/i")).click();
